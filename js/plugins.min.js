  ...
  return (function (t) {
      ...
      (n(3).inspectSource = function (t) {
        ...
        (t.exports = function (t, e, n, c) {
          ...
          l && (o(n, "name") || i(n, "name", e)),
            t[e] !== n &&
              (l && (o(n, s) || i(n, s, t[e] ? "" + t[e] : a.join(String(e)))),
              t === r
                ? (t[e] = n)
                : c
                ? t[e]
      ...
      var a = (function () {
        function t(e, n) {
          (function (t, e) {
            ...
            (this.scrollbarWidth = (0, o.default)()),
            (this.offsetSize = 20),
            ...
            (this.recalculate = (0, s.default)(this.recalculate, 100, {
              leading: !0,
            })),
            this.init();
        }
            ...
            },
            {
              ...
              value: function () {
                ...
                this.options.autoHide &&
                  ...
                  (this.resizeObserver = new c.default(
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, v, b, y, m) {
        ...
        var g,
          ...
          S = !1,
          A = t.prototype,
          k = A[f] || A["@@iterator"] || (b && A[b]),
          j = k || _(b),
          M = b ? (w ? _("entries") : j) : void 0,
          L = ("Array" == e && A.entries) || k;
        if (
          (L &&
            (O = h(L.call(new t()))) !== Object.prototype &&
            O.next &&
            (u(O, x, !0), r || c(O, f) || s(O, f, p)),
          w &&
            k &&
            "values" !== k.name &&
            ((S = !0),
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        ...
        for (; e.length > a; ) r(c, (n = e[a++])) && (~o(l, n) || l.push(n));
        return l;
      };
    },
    function (t, e, n) {
        ...
        "Array",
        {
          from: function (t) {
            ...
            if (
              ...
              for (e = a(f.length), n = new d(e); e > y; y++)
                l(n, y, b ? v(f[y], y) : f[y]);
            else
              for (h = m.call(f), n = new d(); !(i = h.next()).done; y++)
                l(n, y, b ? s(h, v, [i.value, y], !0) : i.value);
            return (n.length = y), n;
          },
        }
      );
    ...
    function (t, e, n) {
      (function (e) {
        ...
        function r(t) {
          ...
          if (
            "symbol" == typeof (e = t) ||
            ((r = e) && "object" == typeof r && v.call(e) == s)
          )
            return o;
          var e, r;
          if (n(t)) {
          ...
          t = t.replace(c, "");
          var f = l.test(t);
          return f || u.test(t) ? h(t.slice(2), f ? 2 : 8) : a.test(t) ? o : +t;
        }
        ...
        t.exports = function (t, e, o) {
          function s(e) {
            var n = h,
              r = f;
            return (h = f = void 0), (E = e), (p = t.apply(r, n));
          }
          function c(t) {
            var n = t - g;
            return void 0 === g || n >= e || n < 0 || (_ && t - E >= d);
          }
          function a() {
            var t,
              n,
            ...
            v = setTimeout(
              a,
              ((n = e - ((t = r) - g)), _ ? y(n, d - (t - E)) : n)
            );
          }
          function l(t) {
            return (v = void 0), x && h ? s(t) : ((h = f = void 0), p);
          }
          function u() {
            var t,
              n = m(),
              r = c(n);
            if (((h = arguments), (f = this), (g = n), r)) {
              if (void 0 === v)
                return (t = g), (E = t), (v = setTimeout(a, e)), O ? s(t) : p;
              if (_) return (v = setTimeout(a, e)), s(g);
            }
            return void 0 === v && (v = setTimeout(a, e)), p;
          }
          var h,
            f,
            d,
          ...
          return (
            ...
            n(o) &&
              ((O = !!o.leading),
              (d = (_ = "maxWait" in o) ? b(r(o.maxWait) || 0, e) : d),
    ...
    function (t, e, n) {
      ...
      function o(t) {
        ...
        if (
          ("border-box" === o.boxSizing &&
            (Math.round(u + a) !== e && (u -= i(o, "left", "right") + a),
            Math.round(h + l) !== n && (h -= i(o, "top", "bottom") + l)),
          t !== document.documentElement)
        ) {
          var f = Math.round(u + a) - e,
            d = Math.round(h + l) - n;
          1 !== Math.abs(f) && (u -= f), 1 !== Math.abs(d) && (h -= d);
        }
        return c(s.left, s.top, u, h);
      }
      function s(t) {
        return l
          ? m(t)
            ? c(0, 0, (e = t.getBBox()).width, e.height)
            : o(t)
          : y;
        var e;
      }
      ...
      var a = (function () {
        ...
        p = "undefined" != typeof MutationObserver && !d,
        v = function () {
          (this.connected_ = !1),
      ...
      (v.prototype.addObserver = function (t) {
        ~this.observers_.indexOf(t) || this.observers_.push(t),
          this.connected_ || this.connect_();
      }),
        (v.prototype.removeObserver = function (t) {
        ...
        (v.prototype.onTransitionEnd_ = function (t) {
      ...
      var w = "undefined" != typeof ResizeObserver ? ResizeObserver : x;
      e.default = w;
    },
    function (t, e) {},
    function (t, e, n) {
...
!(function (e) {
  ...
  var t,
    ...
    r = function (e, t) {
      ...
      a ? e.addEventListener(i, n) : n();
    },
    s = document.querySelector(".pages-stack"),
    o = [].slice.call(s.children),
    c = o.length,
    l = 0,
    d = document.querySelector("header .menu-button"),
    f = document.querySelector(".nav-menu"),
    u = [].slice.call(f.querySelectorAll(".nav-menu--link")),
    h = !1;
    function v() {
      for (var e = g(), t = 0; t < c; ++t) {
        var n = o[t],
          a = e.indexOf(t);
    
        if (l !== t) {
          classie.add(n, "page--inactive");
          
          // Set opacity to 0 for all inactive pages
          n.style.opacity = 0;
    
          if (-1 !== a) {
            n.style.WebkitTransform = "translate3d(0,100%,0)";
            n.style.transform = "translate3d(0,100%,0)";
          } else {
            n.style.WebkitTransform = "translate3d(0,75%,-300px) rotate(0.01deg)";
            n.style.transform = "translate3d(0,75%,-300px) rotate(0.01deg)";
          }
        } else {
          classie.remove(n, "page--inactive");
    
          // Reset opacity to 1 for the active page
          n.style.opacity = 1;
        }
    
        n.style.zIndex = t < l ? parseInt(l - t) : parseInt(c + l - t);
      }
    }
  ...
  function m() {
    h
      ? p()
      : (!(function () {
          classie.add(d, "menu-button--open"),
            classie.add(s, "pages-stack--open"),
            classie.add(f, "nav-menu--open");
          for (var e = g(), t = 0, n = e.length; t < n; ++t) {
            var a = o[e[t]];
  ...
  function y(e) {
    var t = e ? document.getElementById(e) : o[l],
      n = o.indexOf(t),
      a = g(n);
    (t.style.WebkitTransform = "translate3d(0, 0, 0) rotate(0.01deg)"),
      (t.style.transform = "translate3d(0, 0, 0) rotate(0.01deg)"),
      (t.style.opacity = 1);
    for (var i = 0, c = a.length; i < c; ++i) {
      var m = o[a[i]];
      (m.style.WebkitTransform = "translate3d(0,100%,0) rotate(0.01deg)"),
        (m.style.transform = "translate3d(0,100%,0) rotate(0.01deg)");
    }
    e && (l = n),
      classie.remove(d, "menu-button--open"),
      classie.remove(f, "nav-menu--open"),
      r(t, function () {
        classie.remove(s, "pages-stack--open"),
          v(),
          (h = !1),
          u.forEach(function (e) {
            classie.remove(e, "link--active");
          }),
          classie.add(u[l], "link--active");
      });
  }
  function g(e) {
    var t = l + 1 < c ? l + 1 : l + 1 - c,
      n = l + 2 < c ? l + 2 : l + 2 - c,
      a = [];
    return e != l && a.push(l), e != t && a.push(t), e != n && a.push(n), a;
  }
  (t = []),
    (n = "#" + location.hash.slice(2)),
    u.forEach(function (e) {
      t.push(e.getAttribute("href"));
    }),
    t.indexOf(n) >= 0 && (l = t.indexOf(n)),
    u.forEach(function (e) {
      classie.remove(e, "link--active");
    }),
    classie.add(u[l], "link--active"),
    ...
    u.forEach(function (t) {
      ...
      t.addEventListener("click", function (t) {
        t.preventDefault(), y(n), (e.location.hash = "#/" + n);
      });
    }),
    o.forEach(function (t) {
      var n = t.getAttribute("id");
      t.addEventListener("click", function (t) {
        h && (t.preventDefault(), y(n), (e.location.hash = "#/" + n));
      });
    }),
    ...
    e.addEventListener("hashchange", function () {
      ...
      if (
        ...
        t.indexOf(a) >= 0 &&
          ...
          (e.location.hash = "#/" + a.slice(1)),
          location.reload()),
        t.indexOf(n) >= 0)
      ) {
        var i = e.location.hash.slice(2),
...
window.animateText = function () {
  ...
  (t.prototype._navigate = function (t) {
    ...
    var s = this.slides[this.current],
      n = 0,
      r = function () {
        2 === ++n &&
          (i.el.classList.remove("text-slide--current"),
          s.el.classList.add("text-slide--current"),
          (e.isAnimating = !1));
      };
    i.txt.hide(this.effect, function () {
      (i.el.style.opacity = 0), r();
    }),
      s.txt.hide(),
      (s.el.style.opacity = 1),
      s.txt.show(this.effect, function () {
        r();
      });
  }),
    ...
    [].slice.call(document.querySelectorAll("body")).forEach(function (e, i) {
      var s = new t(e.querySelector(".text-slideshow"));
      !(function t() {
        s.next(), setTimeout(t, 3e3);
      })();
    });
};
...
!(function (jQuery, ytp) {
  (jQuery.mbYTPlayer = {
          ...
          function (r) {
            ...
            (e.dataReceived = !0),
              ...
              (e.videoData.aspectratio =
                "auto" == e.opt.ratio ? "16/9" : e.opt.ratio),
    ...
    playlist: function (e, r, t, a) {
      ...
      return (
        ...
        o.videoID ||
          ((o.videos = e),
          (o.videoCounter = 0),
          (o.videoLength = e.length),
          jQuery(o).data("property", e[0]),
          jQuery(o).mb_YTPlayer()),
        "function" == typeof t &&
          jQuery(o).one("YTPChanged", function () {
            t(o);
          }),
    ...
    playNext: function (e) {
      ...
      return (
        r.checkForStartAt &&
          (clearTimeout(r.checkForStartAt), clearInterval(r.getState)),
        r.videoCounter++,
        r.videoCounter >= r.videoLength && e && (r.videoCounter = 0),
        r.videoCounter < r.videoLength
          ? jQuery(r).changeMovie(r.videos[r.videoCounter])
          : r.videoCounter--,
        this
      );
    },
    ...
    playIndex: function (e) {
      ...
      return (
        ...
        (r.videoCounter = e),
        r.videoCounter >= r.videoLength - 1 &&
          (r.videoCounter = r.videoLength - 1),
        jQuery(r).changeMovie(r.videos[r.videoCounter]),
        this
      );
    ...
    setVolume: function (e) {
      var r = this.get(0);
      return (
        e || r.opt.vol || 0 != r.player.getVolume()
          ? (!e && r.player.getVolume() > 0) || (e && r.opt.vol == e)
            ? r.isMute
              ? jQuery(r).YTPUnmute()
              : jQuery(r).YTPMute()
            : ((r.opt.vol = e),
    ...
    mute: function () {
      ...
      if (!e.isMute) {
        ...
        return (
          (r.time = e.currentTime), e.canTrigger && jQuery(e).trigger(r), this
        );
      }
    },
    unmute: function () {
    ...
    removeFilter: function (e, r) {
      return this.each(function () {
        if (("function" == typeof e && ((r = e), (e = null)), e))
          jQuery(this).YTPApplyFilter(e, 0), "function" == typeof r && r(e);
        else
    ...
    removeMask: function () {
      var e = this.get(0),
        r = e.overlay;
      return (
        r.CSSAnimate({ opacity: 0 }, 500, function () {
          (e.hasMask = !1),
            r.css({
              backgroundImage: "",
              backgroundRepeat: "",
    ...
    checkForStart: function (e) {
      ...
      if (jQuery.contains(document, e)) {
        if (
          ...
          e.overlay.removeClass(function (e, r) {
            var t = r.split(" "),
              a = [];
            return (
        ...
        e.player.playVideo(),
          ...
          (e.checkForStartAt = setInterval(function () {
            jQuery(e).YTPMute();
            var t =
              e.player.getVideoLoadedFraction() >= a / e.player.getDuration();
            if (
              e.player.getDuration() > 0 &&
              e.player.getCurrentTime() >= a &&
              t
            ) {
              clearInterval(e.checkForStartAt),
              ...
              if (
                ...
                e.player.pauseVideo(),
                  e.isPlayer ||
                    (jQuery(e.playerEl).CSSAnimate({ opacity: 1 }, 500),
                    e.wrapper.CSSAnimate(
                      { opacity: e.isAlone ? 1 : e.opt.opacity },
                      500
                    )),
    ...
    (jQuery.fn.optimizeDisplay = function (e) {
      var r = this.get(0),
        t = jQuery(r.playerEl),
        a = {};
      (r.opt.align = e || r.opt.align),
        (r.opt.align =
          "undefined " != typeof r.opt.align ? r.opt.align : "center,center");
      ...
      if (r.opt.optimizeDisplay) {
        ...
        (i.width = l.outerWidth()),
          ...
          (a.height =
            "16/9" == r.opt.ratio
              ? Math.ceil(i.width * (9 / 16))
              : Math.ceil(0.75 * i.width)),
          (a.width = i.width),
          (a.height =
            "16/9" == r.opt.ratio
              ? Math.ceil(i.width * (9 / 16))
              : Math.ceil(0.75 * i.width)),
          (a.marginTop = -(a.height - i.height) / 2),
          (a.marginLeft = 0);
        ...
        n &&
          ...
          (a.width =
            "16/9" == r.opt.ratio
              ? Math.floor(i.height * (16 / 9))
              : Math.floor(i.height * (4 / 3))),
          (a.marginTop = 0),
          (a.marginLeft = -(a.width - i.width) / 2));
        for (var s in o) {
          switch (o[s].trim()) {
            case "top":
    ...
    animate: function (e, r, t, a, o) {
      return this.each(function () {
        function i() {
          (l.called = !0),
            (l.CSSAIsRunning = !1),
            n.off(jQuery.CSS.transitionEnd + "." + l.id),
            clearTimeout(l.timeout),
            n.css(jQuery.CSS.sfx + "transition", ""),
            "function" == typeof o && o.apply(l),
            "function" == typeof l.CSSqueue &&
              (l.CSSqueue(), (l.CSSqueue = null));
        }
        var l = this,
          n = jQuery(this);
        ...
        if (
          ...
          ((l.CSSqueue = null), (l.eventType = s.type), 0 !== n.length && e)
        ) {
          if (
          ...
          var d = jQuery.CSS.getProp(e),
            T = {};
          jQuery.extend(T, e),
            (T[jQuery.CSS.sfx + "transition-property"] = d),
            (T[jQuery.CSS.sfx + "transition-duration"] = r + "ms"),
            (T[jQuery.CSS.sfx + "transition-delay"] = t + "ms"),
            (T[jQuery.CSS.sfx + "transition-timing-function"] = a),
            setTimeout(function () {
              n.one(jQuery.CSS.transitionEnd + "." + l.id, i), n.css(T);
            }, 1),
            (l.timeout = setTimeout(function () {
              return l.called || !o
                ? ((l.called = !1), void (l.CSSAIsRunning = !1))
                : (n.css(jQuery.CSS.sfx + "transition", ""),
                  o.apply(l),
                  (l.CSSAIsRunning = !1),
                  void (
  ...
  (function (e) {
    ...
    (e.simpleSlider = {
      ...
      init: function (t) {
        return this.each(function () {
          ...
          o.addClass("simpleSlider"),
            (a.opt = {}),
            e.extend(a.opt, e.simpleSlider.defaults, t),
            e.extend(a.opt, o.data());
          ...
          o.prepend(l),
            ...
            o.updateSliderVal(),
            a.opt.readonly ||
              (o.on(e.simpleSlider.events.start, function (e) {
                r && (e = e.changedTouches[0]),
                  (a.canSlide = !0),
                  o.updateSliderVal(e),
                  o.css({ cursor: "col-resize" }),
                  e.preventDefault(),
                  e.stopPropagation();
              }),
              e(document)
                .on(e.simpleSlider.events.move, function (t) {
                  r && (t = t.changedTouches[0]),
                    a.canSlide &&
      ...
      updateSliderVal: function (r) {
        ...
        if (o.opt) {
          o.opt.initialval =
            "number" == typeof o.opt.initialval
              ? o.opt.initialval
              : o.opt.initialval(o);
          ...
          (o.x =
            "object" == typeof r
              ? r.clientX + document.body.scrollLeft - a.offset().left
              : "number" == typeof r
              ? (r * i) / o.opt.scale
              : (o.opt.initialval * i) / o.opt.scale),
            (o.y =
              "object" == typeof r
                ? r.clientY + document.body.scrollTop - a.offset().top
                : "number" == typeof r
                ? ((o.opt.scale - o.opt.initialval - r) * l) / o.opt.scale
                : (o.opt.initialval * l) / o.opt.scale),
            (o.y = a.outerHeight() - o.y),
            (o.scaleX = (o.x * o.opt.scale) / i),
            (o.scaleY = (o.y * o.opt.scale) / l),
            (o.outOfRangeX =
              o.scaleX > o.opt.scale
                ? o.scaleX - o.opt.scale
                : o.scaleX < 0
                ? o.scaleX
                : 0),
            (o.outOfRangeY =
              o.scaleY > o.opt.scale
                ? o.scaleY - o.opt.scale
                : o.scaleY < 0
                ? o.scaleY
                : 0),
            (o.outOfRange =
              "h" == o.opt.orientation ? o.outOfRangeX : o.outOfRangeY),
            (o.value =
              void 0 !== r
                ? "h" == o.opt.orientation
                  ? o.x >= a.outerWidth()
                ...
                : o.scaleY),
            "h" == o.opt.orientation
              ? o.level.width(t(o.x, i) + "%")
              : o.level.height(t(o.y, l)),
      ...
      d = {
        ...
        _events: function () {
          s.$el.on("click", s.options.elements.pagination + " a", function (i) {
            ...
            (t = s._upcomingSlide(n, !0)) !== s.current &&
    ...
    return (
      ...
      s.options.hashchange &&
        t(i).on("hashchange", function () {
          var i,
            t = s._parseHash();
          (i = s._upcomingSlide(t)) >= 0 && i !== s.current && s.animate(i);
        }),
